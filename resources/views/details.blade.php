        ...
        <div class="container header-datile">
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <ul class='list-items'>
                        <li><i class="fa fa-building"></i> UNHCR</li>
                        <li><i class="far fa-compass"></i> Sana'a</li>
                        <li><i class='fa fa-calendar'></i> posted: <span> 2 days ago</span></li>
                        <li><i class='fa fa-calendar'></i> Deadline: <span>  30 Feb 2022</span></li>
                    </ul>
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-sm-9 content-left">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Considering UNHCR's education global strategy, which provides overall 
                    ...
                    <div class="card-footer">
                        ...
                        <p>The deadline for submitting applications is Thursday, February 3, 2022 at 12:00 noon, Yemen time.</p>
                        <p>To apply via the following link:</p>
                        <h4>https://forms.gle/1KFskcB2dNerpU2r7</h4>
                    </div>
                </div>
                <div class="col sm-2 ">
